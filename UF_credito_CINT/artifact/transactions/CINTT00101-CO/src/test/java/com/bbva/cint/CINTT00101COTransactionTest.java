...
/**
 * Test for transaction CINTT00101COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CINTT00101COTest.xml" })
public class CINTT00101COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(CINTT00101COTransactionTest.class);
	
	@Autowired
	private CINTT00101COTransaction transaction;
	...
	public void testTransaction(){
		fillDataIN();
		this.transaction.execute();
		DataOutCreDTO out = this.transaction.getDataoutcredto();
		//out.toString();
	}
	...
	private void fillDataIN(){
		...
		in.setPan("");
		in.setRutaBase("");
		this.transaction.setDataoincredto(in);
	}
