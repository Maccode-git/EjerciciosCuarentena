...
/**
 * Test for transaction CFINT00101COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CFINT00101COTest.xml" })
public class CFINT00101COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(CFINT00101COTransactionTest.class);
	
	@Autowired
	private CFINT00101COTransaction transaction;
	...
	public void testTransaction(){
		fillDataIN();
		this.transaction.execute();
		DataOutOneDTO out = this.transaction.getDataoutonedto();
	}
	
	/**
	 * Method fillDataIN
	 */
	private void fillDataIN(){
		DataInOneDTO in = new DataInOneDTO();
		in.setPan("");
		in.setOrigen("CARTAJENA");
		in.setDestino("ARGENTINA");
		in.setNumCuotas(36);
		this.transaction.setDataInOneDTO(in);
	}
}
