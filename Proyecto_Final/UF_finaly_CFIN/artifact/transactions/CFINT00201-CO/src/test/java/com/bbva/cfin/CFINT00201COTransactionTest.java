...
/**
 * Test for transaction CFINT00201COTransaction
 */
@RunWith(SpringJUnit4ClassRunner.class)
@ContextConfiguration(locations = {
		"classpath:/META-INF/spring/elara-test.xml",
		"classpath:/META-INF/spring/CFINT00201COTest.xml" })
public class CFINT00201COTransactionTest {
	private static final Logger LOGGER = LoggerFactory.getLogger(CFINT00201COTransactionTest.class);
	
	@Autowired
	private CFINT00201COTransaction transaction;
